import zt, { ipcMain as X, app as Oe, desktopCapturer as ec, screen as es, BrowserWindow as vd } from "electron";
import De from "node:path";
import { fileURLToPath as _d } from "node:url";
import pn from "node:fs";
import { spawn as An, exec as dt, fork as Ad } from "node:child_process";
...
import ic from "zlib";
import Cd from "http";
var Pe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, je = {}, Kt = {}, xe = {};
...
var Et = Td, $d = process.cwd, Jr = null, bd = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return Jr || (Jr = $d.call(process)), Jr;
};
try {
  process.cwd();
} catch {
...
var Dd = Fd, Nd = Object.getPrototypeOf || function(e) {
  return e.__proto__;
};
function Fd(e) {
...
var oe = It, xd = Id, Ld = Od, Ud = Dd, Nr = ta, ye, ni;
typeof Symbol == "function" && typeof Symbol.for == "function" ? (ye = Symbol.for("graceful-fs.queue"), ni = Symbol.for("graceful-fs.previous")) : (ye = "___graceful-fs.queue", ni = "___graceful-fs.previous");
function kd() {
}
function oc(e, t) {
...
var Vt = kd;
Nr.debuglog ? Vt = Nr.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (Vt = function() {
...
if (!oe[ye]) {
  ...
  oc(oe, Md), oe.close = function(e) {
    ...
    Vt(oe[ye]), tc.equal(oe[ye].length, 0);
  });
}
Pe[ye] || oc(Pe, oe[ye]);
var Le = na(Ud(oe));
process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !oe.__patched && (Le = na(oe), oe.__patched = !0);
function na(e) {
  xd(e), e.gracefulify = na, e.createReadStream = q, e.createWriteStream = K;
  var t = e.readFile;
  e.readFile = n;
  function n(L, w, G) {
  ...
  function i(L, w, G, z) {
    ...
    function ne(R, I, P, b, D) {
      return r(R, I, P, function(O) {
        O && (O.code === "EMFILE" || O.code === "ENFILE") ? nn([ne, [R, I, P, b], O, D || Date.now(), Date.now()]) : typeof b == "function" && b.apply(this, arguments);
      });
    }
  }
  var o = e.appendFile;
  ...
  function f(L, w, G) {
    ...
    var z = c.test(process.version) ? function(I, P, b, D) {
      return p(I, ne(
        I,
        P,
        b,
    ...
    function ne(R, I, P, b) {
      return function(D, O) {
        D && (D.code === "EMFILE" || D.code === "ENFILE") ? nn([
          ...
          b || Date.now(),
          Date.now()
        ]) : (O && O.sort && O.sort(), typeof P == "function" && P.call(this, D, O));
      };
    }
  }
  ...
  var y = e.WriteStream;
  y && (N.prototype = Object.create(y.prototype), N.prototype.open = k), Object.defineProperty(e, "ReadStream", {
    get: function() {
      return C;
    },
    set: function(L) {
...
function nn(e) {
  Vt("ENQUEUE", e[0].name, e[1]), oe[ye].push(e), ra();
}
var Fr;
function rs() {
...
function ra() {
  if (clearTimeout(Fr), Fr = void 0, oe[ye].length !== 0) {
    ...
    if (i === void 0)
      ...
      s >= p ? (Vt("RETRY", t.name, n), t.apply(null, n.concat([i]))) : oe[ye].push(e);
    }
    Fr === void 0 && (Fr = setTimeout(ra, 0));
  }
}
(function(e) {
  const t = xe.fromCallback, n = Le, r = [
    "access",
    "appendFile",
    "chmod",
    "chown",
...
ac.checkPath = function(t) {
  if (process.platform === "win32" && /[<>:"|?*]/.test(t.replace(Bd.parse(t).root, ""))) {
    const r = new Error(`Path contains invalid characters: ${t}`);
    throw r.code = "EINVAL", r;
  }
};
const sc = Kt, { checkPath: lc } = ac, cc = (e) => {
  const t = { mode: 511 };
  return typeof e == "number" ? e : { ...t, ...e }.mode;
};
ia.makeDir = async (e, t) => (lc(e), sc.mkdir(e, {
  mode: cc(t),
  recursive: !0
}));
ia.makeDirSync = (e, t) => (lc(e), sc.mkdirSync(e, {
  mode: cc(t),
  recursive: !0
}));
const jd = xe.fromPromise, { makeDir: Hd, makeDirSync: Vi } = ia, Yi = jd(Hd);
var st = {
  mkdirs: Yi,
  mkdirsSync: Vi,
  // alias
...
const yn = Kt, ge = ae, Yd = ta;
function zd(e, t, n) {
  const r = n.dereference ? (i) => yn.stat(i, { bigint: !0 }) : (i) => yn.lstat(i, { bigint: !0 });
  return Promise.all([
    r(e),
    r(t).catch((i) => {
...
function Xd(e, t, n) {
  let r;
  const i = n.dereference ? (a) => yn.statSync(a, { bigint: !0 }) : (a) => yn.lstatSync(a, { bigint: !0 }), o = i(e);
  try {
    r = i(t);
  } catch (a) {
...
function Jd(e, t, n, r) {
  const { srcStat: i, destStat: o } = Xd(e, t, r);
  if (o) {
    if (dr(i, o)) {
...
function dc(e, t, n, r, i) {
  ...
  yn.stat(a, { bigint: !0 }, (s, l) => s ? s.code === "ENOENT" ? i() : i(s) : dr(t, l) ? i(new Error(gi(e, n, r))) : dc(e, t, a, r, i));
}
function hc(e, t, n, r) {
...
const Me = Le, Yn = ae, Qd = st.mkdirs, Zd = Jt.pathExists, eh = fc.utimesMillis, zn = Sn;
function th(e, t, n, r) {
  typeof n == "function" && !r ? (r = n, n = {}) : typeof n == "function" && (n = { filter: n }), r = r || function() {
    ...
    zn.checkParentPaths(e, a, t, "copy", (l) => l ? r(l) : n.filter ? pc(is, s, e, t, n, r) : is(s, e, t, n, r));
  });
}
...
function nh(e, t, n, r, i) {
  return r.filter ? pc(ri, e, t, n, r, i) : ri(e, t, n, r, i);
}
function ri(e, t, n, r, i) {
  (r.dereference ? Me.stat : Me.lstat)(t, (a, s) => a ? i(a) : s.isDirectory() ? ch(s, e, t, n, r, i) : s.isFile() || s.isCharacterDevice() || s.isBlockDevice() ? rh(s, e, t, n, r, i) : s.isSymbolicLink() ? dh(e, t, n, r, i) : s.isSocket() ? i(new Error(`Cannot copy a socket file: ${t}`)) : s.isFIFO() ? i(new Error(`Cannot copy a FIFO pipe: ${t}`)) : i(new Error(`Unknown file: ${t}`)));
}
function rh(e, t, n, r, i, o) {
  return t ? ih(e, n, r, i, o) : mc(e, n, r, i, o);
}
function ih(e, t, n, r, i) {
  if (r.overwrite)
    Me.unlink(n, (o) => o ? i(o) : mc(e, t, n, r, i));
  else return r.errorOnExist ? i(new Error(`'${n}' already exists`)) : i();
}
function mc(e, t, n, r, i) {
  Me.copyFile(t, n, (o) => o ? i(o) : r.preserveTimestamps ? oh(e.mode, t, n, i) : Ei(n, e.mode, i));
}
function oh(e, t, n, r) {
  return ah(e) ? sh(n, e, (i) => i ? r(i) : os(e, t, n, r)) : os(e, t, n, r);
}
function ah(e) {
  return (e & 128) === 0;
}
...
function os(e, t, n, r) {
  lh(t, n, (i) => i ? r(i) : Ei(n, e, r));
}
function Ei(e, t, n) {
  return Me.chmod(e, t, n);
}
function lh(e, t, n) {
  Me.stat(e, (r, i) => r ? n(r) : eh(t, i.atime, i.mtime, n));
}
function ch(e, t, n, r, i, o) {
  return t ? gc(n, r, i, o) : uh(e.mode, n, r, i, o);
}
function uh(e, t, n, r, i) {
  Me.mkdir(n, (o) => {
    if (o) return i(o);
    gc(t, n, r, (a) => a ? i(a) : Ei(n, e, i));
  });
}
function gc(e, t, n, r) {
  Me.readdir(e, (i, o) => i ? r(i) : Ec(o, e, t, n, r));
}
function Ec(e, t, n, r, i) {
  const o = e.pop();
  return o ? fh(e, o, t, n, r, i) : i();
}
function fh(e, t, n, r, i, o) {
  ...
  zn.checkPaths(a, s, "copy", i, (l, p) => {
    if (l) return o(l);
    const { destStat: c } = p;
    nh(c, a, s, i, (f) => f ? o(f) : Ec(e, n, r, i, o));
  });
}
function dh(e, t, n, r, i) {
  Me.readlink(t, (o, a) => {
    ...
    if (r.dereference && (a = Yn.resolve(process.cwd(), a)), e)
      Me.readlink(n, (s, l) => s ? s.code === "EINVAL" || s.code === "UNKNOWN" ? Me.symlink(a, n, i) : i(s) : (r.dereference && (l = Yn.resolve(process.cwd(), l)), zn.isSrcSubdir(a, l) ? i(new Error(`Cannot copy '${a}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && zn.isSrcSubdir(l, a) ? i(new Error(`Cannot overwrite '${l}' with '${a}'.`)) : hh(a, n, i)));
    else
...
var ph = th;
const Ce = Le, Xn = ae, mh = st.mkdirsSync, gh = fc.utimesMillisSync, Kn = Sn;
function Eh(e, t, n) {
...
function yh(e, t, n, r) {
  ...
  return Ce.existsSync(i) || mh(i), yc(e, t, n, r);
}
function wh(e, t, n, r) {
...
function yc(e, t, n, r) {
  ...
  if (o.isDirectory()) return $h(o, e, t, n, r);
  if (o.isFile() || o.isCharacterDevice() || o.isBlockDevice()) return vh(o, e, t, n, r);
  if (o.isSymbolicLink()) return Rh(e, t, n, r);
  throw o.isSocket() ? new Error(`Cannot copy a socket file: ${t}`) : o.isFIFO() ? new Error(`Cannot copy a FIFO pipe: ${t}`) : new Error(`Unknown file: ${t}`);
}
function vh(e, t, n, r, i) {
  return t ? _h(e, n, r, i) : wc(e, n, r, i);
}
function _h(e, t, n, r) {
  if (r.overwrite)
    return Ce.unlinkSync(n), wc(e, t, n, r);
  if (r.errorOnExist)
    throw new Error(`'${n}' already exists`);
}
function wc(e, t, n, r) {
  return Ce.copyFileSync(t, n), r.preserveTimestamps && Ah(e.mode, t, n), aa(n, e.mode);
}
function Ah(e, t, n) {
  return Sh(e) && Th(n, e), Ch(t, n);
}
function Sh(e) {
  return (e & 128) === 0;
}
...
function Ch(e, t) {
  ...
  return gh(t, n.atime, n.mtime);
}
function $h(e, t, n, r, i) {
  return t ? vc(n, r, i) : bh(e.mode, n, r, i);
}
function bh(e, t, n, r) {
  return Ce.mkdirSync(n), vc(t, n, r), aa(n, e);
}
function vc(e, t, n) {
  Ce.readdirSync(e).forEach((r) => Ih(r, e, t, n));
}
function Ih(e, t, n, r) {
...
var Ph = Eh;
const Dh = xe.fromCallback;
var sa = {
  copy: Dh(ph),
  copySync: Ph
};
const as = Le, _c = ae, Q = tc, Jn = process.platform === "win32";
function Ac(e) {
  [
    "unlink",
    "chmod",
...
function la(e, t, n) {
  let r = 0;
  typeof t == "function" && (n = t, t = {}), Q(e, "rimraf: missing path"), Q.strictEqual(typeof e, "string", "rimraf: path should be a string"), Q.strictEqual(typeof n, "function", "rimraf: callback function required"), Q(t, "rimraf: invalid options argument provided"), Q.strictEqual(typeof t, "object", "rimraf: options should be object"), Ac(t), ss(e, t, function i(o) {
    if (o) {
...
function Sc(e, t) {
  let n;
  t = t || {}, Ac(t), Q(e, "rimraf: missing path"), Q.strictEqual(typeof e, "string", "rimraf: path should be a string"), Q(t, "rimraf: missing options"), Q.strictEqual(typeof t, "object", "rimraf: options should be object");
  try {
    n = t.lstatSync(e);
  } catch (r) {
    if (r.code === "ENOENT")
...
function Fh(e, t) {
  if (Q(e), Q(t), t.readdirSync(e).forEach((n) => Sc(_c.join(e, n), t)), Jn) {
    const n = Date.now();
    do
      try {
...
var xh = la;
la.sync = Sc;
const ii = Le, Lh = xe.fromCallback, Tc = xh;
function Uh(e, t) {
...
const Mh = xe.fromPromise, Cc = Kt, $c = ae, bc = st, Ic = yi, us = Mh(async function(t) {
  let n;
  try {
    n = await Cc.readdir(t);
  } catch {
    return bc.mkdirs(t);
  }
  return Promise.all(n.map((r) => Ic.remove($c.join(t, r))));
});
function fs(e) {
  let t;
  try {
...
const jh = xe.fromCallback, Rc = ae, vt = Le, Oc = st;
function Hh(e, t) {
  function n() {
    vt.writeFile(e, "", (r) => {
      if (r) return t(r);
  ...
  vt.stat(e, (r, i) => {
    ...
    vt.stat(o, (a, s) => {
      if (a)
        return a.code === "ENOENT" ? Oc.mkdirs(o, (l) => {
          if (l) return t(l);
          n();
        }) : t(a);
...
const Wh = xe.fromCallback, Pc = ae, wt = Le, Dc = st, Vh = Jt.pathExists, { areIdentical: Nc } = Sn;
function Yh(e, t, n) {
  function r(i, o) {
    wt.link(i, o, (a) => {
      if (a) return n(a);
...
const _t = ae, Gn = Le, Kh = Jt.pathExists;
function Jh(e, t, n) {
  if (_t.isAbsolute(e))
    ...
    }));
  {
    ...
    return Kh(i, (o, a) => o ? n(o) : a ? n(null, {
      toCwd: i,
      toDst: e
...
const rp = xe.fromCallback, xc = ae, Qe = Kt, Lc = st, ip = Lc.mkdirs, op = Lc.mkdirsSync, Uc = Zh, ap = Uc.symlinkPaths, sp = Uc.symlinkPathsSync, kc = np, lp = kc.symlinkType, cp = kc.symlinkTypeSync, up = Jt.pathExists, { areIdentical: Mc } = Sn;
function fp(e, t, n, r) {
...
function dp(e, t, n) {
  ...
  const i = sp(e, t);
  e = i.toDst, n = cp(i.toCwd, n);
  const o = xc.dirname(t);
  return Qe.existsSync(o) || op(o), Qe.symlinkSync(e, t, n);
}
var hp = {
  createSymlink: rp(fp),
  createSymlinkSync: dp
};
const { createFile: hs, createFileSync: ps } = qh, { createLink: ms, createLinkSync: gs } = Xh, { createSymlink: Es, createSymlinkSync: ys } = hp;
var pp = {
  // file
  createFile: hs,
  createFileSync: ps,
...
var ca = { stringify: mp, stripBom: gp };
let wn;
try {
  wn = Le;
} catch {
...
const wi = xe, { stringify: Bc, stripBom: jc } = ca;
...
const Cp = xe.fromCallback, qn = Le, Hc = ae, Gc = st, $p = Jt.pathExists;
function bp(e, t, n, r) {
...
function Ip(e, ...t) {
  ...
  Gc.mkdirsSync(n), qn.writeFileSync(e, ...t);
}
var ua = {
  outputFile: Cp(bp),
  outputFileSync: Ip
};
const { stringify: Rp } = ca, { outputFile: Op } = ua;
async function Pp(e, t, n = {}) {
  const r = Rp(t, n);
  await Op(e, r, n);
}
var Dp = Pp;
const { stringify: Np } = ca, { outputFileSync: Fp } = ua;
function xp(e, t, n) {
  const r = Np(t, n);
  Fp(e, r, n);
}
var Lp = xp;
const Up = xe.fromPromise, Fe = Tp;
Fe.outputJson = Up(Dp);
Fe.outputJsonSync = Lp;
...
var kp = Fe;
const Mp = Le, Oo = ae, Bp = sa.copy, qc = yi.remove, jp = st.mkdirp, Hp = Jt.pathExists, ws = Sn;
function Gp(e, t, n, r) {
  ...
  ws.checkPaths(e, t, "move", n, (o, a) => {
    ...
    ws.checkParentPaths(e, s, t, "move", (p) => {
      if (p) return r(p);
      if (qp(t)) return vs(e, t, i, l, r);
      jp(Oo.dirname(t), (c) => c ? r(c) : vs(e, t, i, l, r));
    });
  });
}
function qp(e) {
...
function vs(e, t, n, r, i) {
  ...
  if (n)
    return qc(t, (o) => o ? i(o) : zi(e, t, n, i));
  Hp(t, (o, a) => o ? i(o) : a ? i(new Error("dest already exists.")) : zi(e, t, n, i));
}
function zi(e, t, n, r) {
  Mp.rename(e, t, (i) => i ? i.code !== "EXDEV" ? r(i) : Wp(e, t, n, r) : r());
}
function Wp(e, t, n, r) {
  Bp(e, t, {
    overwrite: n,
...
var Vp = Gp;
const Wc = Le, Po = ae, Yp = sa.copySync, Vc = yi.removeSync, zp = st.mkdirpSync, _s = Sn;
function Xp(e, t, n) {
  n = n || {};
  const r = n.overwrite || n.clobber || !1, { srcStat: i, isChangingCase: o = !1 } = _s.checkPathsSync(e, t, "move", n);
  return _s.checkParentPathsSync(e, i, t, "move"), Kp(t) || zp(Po.dirname(t)), Jp(e, t, r, o);
}
function Kp(e) {
...
function Jp(e, t, n, r) {
  ...
  if (n)
    return Vc(t), Xi(e, t, n);
  if (Wc.existsSync(t)) throw new Error("dest already exists.");
  return Xi(e, t, n);
}
function Xi(e, t, n) {
  try {
...
const nm = nc;
class rm extends nm.EventEmitter {
  get cancelled() {
...
Tt.CancellationToken = rm;
class Do extends Error {
  constructor() {
    super("cancelled");
  }
}
Tt.CancellationError = Do;
var Tn = {};
...
var Ne = {}, No = { exports: {} }, Lr = { exports: {} }, Ki, As;
function om() {
  if (As) return Ki;
  As = 1;
...
function Yc() {
  ...
  Ss = 1;
  function e(t) {
    r.debug = r, r.default = r, r.coerce = p, r.disable = s, r.enable = o, r.enabled = l, r.humanize = om(), r.destroy = c, Object.keys(t).forEach((f) => {
      r[f] = t[f];
    ...
    function r(f) {
      ...
      function A(...C) {
        if (!A.enabled)
          return;
        const T = A, N = Number(/* @__PURE__ */ new Date()), k = N - (h || N);
        T.diff = k, T.prev = h, T.curr = N, h = N, C[0] = r.coerce(C[0]), typeof C[0] != "string" && C.unshift("%O");
        let q = 0;
...
function lm() {
  if ($s) return Zi;
  $s = 1;
  const e = mi, t = rc, n = sm(), { env: r } = process;
  let i;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? No.exports = am() : No.exports = cm();
var um = No.exports, hr = {};
Object.defineProperty(hr, "__esModule", { value: !0 });
hr.ProgressCallbackTransform = void 0;
const fm = ur;
class dm extends fm.Transform {
  constructor(t, n, r) {
...
class fa extends Error {
  constructor(t, n = `HTTP error: ${wm.get(t) || t}`, r = null) {
...
class cn {
  ...
  request(t, n = new Em.CancellationToken(), r) {
    oi(t);
...
`));
    ...
    t.on("error", o), t.on("data", (m) => h += m), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const m = gn(t, "content-type"), y = m != null && (Array.isArray(m) ? m.find((E) => E.includes("json")) != null : m.includes("json"));
          o(xo(t, `method: ${n.method || "GET"} url: ${n.protocol || "https:"}//${n.hostname}${n.port ? `:${n.port}` : ""}${n.path}
  ...
  static prepareRedirectUrlOptions(t, n) {
    ...
    if (i != null && i.authorization) {
      const o = cn.reconstructOriginalUrl(n), a = zc(t, n);
...
function Xc(e, t) {
  const n = oi(t), r = zc(e, t);
  return da(r, n), n;
}
function da(e, t) {
  t.protocol = e.protocol, t.hostname = e.hostname, e.port ? t.port = e.port : t.port && delete t.port, t.path = e.pathname + e.search;
}
class Lo extends gm.Transform {
  // noinspection JSUnusedGlobalSymbols
  get actual() {
    return this._actual;
  }
  constructor(t, n = "sha512", r = "base64") {
    super(), this.expected = t, this.algorithm = n, this.encoding = r, this._actual = null, this.isValidateOnEnd = !0, this.digester = (0, hm.createHash)(n);
  }
  // noinspection JSUnusedGlobalSymbols
  _transform(t, n, r) {
...
function Am(e, t) {
  if (!_m(gn(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const n = [];
...
function Kc(e, t) {
  if (typeof e == "object" && e !== null && (typeof t == "object" && t !== null)) {
    ...
    return i.length === o.length && i.every((a) => Kc(e[a], t[a]));
  }
  return e === t;
}
var pr = {};
...
pr.githubUrl = Tm;
pr.githubTagPrefix = Cm;
pr.getS3LikeProviderBaseUrl = $m;
...
function Im(e) {
  ...
  return Jc(`https://${e.name}.${e.region}.digitaloceanspaces.com`, e.path);
}
var ha = {};
...
async function Qc(e, t) {
  var n;
  const { retries: r, interval: i, backoff: o = 0, attempt: a = 0, shouldRetry: s, cancellationToken: l = new Rm.CancellationToken() } = t;
  try {
    return await e();
  } catch (p) {
    if (await Promise.resolve((n = s == null ? void 0 : s(p)) !== null && n !== void 0 ? n : !0) && r > 0 && !l.cancelled)
      return await new Promise((c) => setTimeout(c, i + o * a)), await Qc(e, { ...t, retries: r - 1, attempt: a + 1 });
    throw p;
  }
}
var pa = {};
...
const Zc = fr, eu = Tn, Pm = "options.name must be either a string or a Buffer", Rs = (0, Zc.randomBytes)(16);
Rs[0] = Rs[0] | 1;
const ei = {}, V = [];
for (let e = 0; e < 256; e++) {
...
function Dm(e, t, n, r, i = Wn.ASCII) {
  const o = (0, Zc.createHash)(t);
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, eu.newError)(Pm, "ERR_INVALID_UUID_NAME");
...
(function(e) {
  (function(t) {
    ...
    function a(d) {
      D(d), d.cdata !== "" && (b(d, "oncdata", d.cdata), d.cdata = ""), d.script !== "" && (b(d, "onscript", d.script), d.script = "");
    }
    r.prototype = {
      end: function() {
        W(this);
    ...
    var h = "[CDATA[", m = "DOCTYPE", y = "http://www.w3.org/XML/1998/namespace", E = "http://www.w3.org/2000/xmlns/", A = { xml: y, xmlns: E }, C = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, T = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, N = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, k = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function q(d) {
      return d === " " || d === `
` || d === "\r" || d === "	";
    }
...
Char: ` + d.c), u = new Error(u), d.error = u, z(d, "onerror", u), d;
    ...
    function W(d) {
      return d.sawRoot && !d.closedRoot && F(d, "Unclosed root tag"), d.state !== w.BEGIN && d.state !== w.BEGIN_WHITESPACE && d.state !== w.TEXT && M(d, "Unexpected end"), D(d), d.c = "", d.closed = !0, z(d, "onend"), r.call(d, d.strict, d.opt), d;
    }
    function F(d, u) {
...
Actual: ` + d.attribValue
    ...
    function ve(d, u) {
      if (d.opt.xmlns) {
        ...
        for (var re = 0, le = d.attribList.length; re < le; re++) {
          var _e = d.attribList[re], Ae = _e[0], Ye = _e[1], he = de(Ae, !0), ze = he.prefix, ki = he.local, Cr = ze === "" ? "" : S.ns[ze] || "", On = {
            name: Ae,
            value: Ye,
            prefix: ze,
            local: ki,
          ...
          ), On.uri = ze), d.tag.attributes[Ae] = On, b(d, "onattribute", On);
        }
    ...
    function Tr(d) {
      ...
      for (var S = 0, v = ""; v = en(d, S++), u.c = v, !!v; )
          ...
          case w.TEXT:
            if (u.sawRoot && !u.closedRoot) {
              for (var re = S - 1; v && v !== "<" && v !== "&"; )
                v = en(d, S++), v && u.trackPosition && (u.position++, v === `
...
` ? (u.line++, u.column = 0) : u.column++);
          ...
          case w.PROC_INST_ENDING:
            ...
            continue;
          case w.OPEN_TAG:
            te(T, v) ? u.tagName += v : (J(u), v === ">" ? ve(u) : v === "/" ? u.state = w.OPEN_TAG_SLASH : (q(v) || F(u, "Invalid character in tag name"), u.state = w.ATTRIB));
            continue;
          ...
          case w.ATTRIB:
            ...
            continue;
          case w.ATTRIB_NAME:
            v === "=" ? u.state = w.ATTRIB_VALUE : v === ">" ? (F(u, "Attribute without value"), u.attribValue = u.attribName, B(u), ve(u)) : q(v) ? u.state = w.ATTRIB_NAME_SAW_WHITE : te(T, v) ? u.attribName += v : F(u, "Invalid attribute name");
            continue;
          ...
          case w.ATTRIB_VALUE_CLOSED:
            q(v) ? u.state = w.ATTRIB : v === ">" ? ve(u) : v === "/" ? u.state = w.OPEN_TAG_SLASH : te(C, v) ? (F(u, "No whitespace between attributes"), u.attribName = v, u.attribValue = "", u.state = w.ATTRIB_NAME) : F(u, "Invalid attribute name");
            continue;
          ...
          case w.ATTRIB_VALUE_ENTITY_U:
            ...
            if (v === ";") {
              var Ae = Ve(u);
              u.opt.unparsedEntities && !Object.values(t.XML_ENTITIES).includes(Ae) ? ((u.entityCount += 1) > u.opt.maxEntityCount && M(
                u,
                "Parsed entity count exceeds max entity count"
              ), (u.entityDepth += 1) > u.opt.maxEntityDepth && M(
                u,
                "Parsed entity depth exceeds max entity depth"
              ), u.entity = "", u.state = le, u.write(Ae), u.entityDepth -= 1) : (u[_e] += Ae, u.entity = "", u.state = le);
            } else te(u.entity.length ? k : N, v) ? u.entity += v : (F(u, "Invalid character in entity name"), u[_e] += "&" + u.entity + v, u.entity = "", u.state = le);
            continue;
          default:
    ...
    String.fromCodePoint || function() {
      var d = String.fromCharCode, u = Math.floor, S = function() {
        var v = 16384, Y = [], re, le, _e = -1, Ae = arguments.length;
        if (!Ae)
          return "";
        for (var Ye = ""; ++_e < Ae; ) {
          ...
          he <= 65535 ? Y.push(he) : (he -= 65536, re = (he >> 10) + 55296, le = he % 1024 + 56320, Y.push(re, le)), (_e + 1 === Ae || Y.length > v) && (Ye += d.apply(null, Y), Y.length = 0);
        }
        return Ye;
      };
...
mr.XElement = nu;
const xm = new RegExp(/^[A-Za-z_][:A-Za-z0-9_-]*$/i);
function Lm(e) {
  return xm.test(e);
}
function Ps(e, t, n) {
...
function Um(e) {
  let t = null;
  const n = Fm.parser(!0, {}), r = [];
  return n.onopentag = (i) => {
    const o = new nu(i.name);
...
function zm(e, t) {
  if (t = t || {}, Object.keys(t).forEach(function(n) {
    ...
    return n;
  }, this.instanceOf = t.instanceOf || null, this.predicate = t.predicate || null, this.represent = t.represent || null, this.representName = t.representName || null, this.defaultStyle = t.defaultStyle || null, this.multi = t.multi || !1, this.styleAliases = Ym(t.styleAliases || null), Vm.indexOf(this.kind) === -1)
    throw new Ds('Unknown kind "' + this.kind + '" is specified for "' + e + '" YAML type.');
}
var Ue = zm, xn = gr, no = Ue;
function Ns(e, t) {
  var n = [];
...
Uo.prototype.extend = function(t) {
  ...
  return i.implicit = (this.implicit || []).concat(n), i.explicit = (this.explicit || []).concat(r), i.compiledImplicit = Ns(i, "implicit"), i.compiledExplicit = Ns(i, "explicit"), i.compiledTypeMap = Xm(i.compiledImplicit, i.compiledExplicit), i;
};
var ou = Uo, Km = Ue, au = new Km("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), Jm = Ue, su = new Jm("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), Qm = Ue, lu = new Qm("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var uu = new eg("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: tg,
  construct: ng,
  predicate: rg,
...
var fu = new ig("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: og,
  construct: ag,
  predicate: sg,
...
var du = new cg("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: hg,
  construct: pg,
  predicate: mg,
...
}), hu = Ze, gg = Ue, Eg = new RegExp(
  // 2.5e4, 2.5 and integers
  "^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$"
);
function yg(e) {
  return !(e === null || !Eg.test(e) || // Quick hack to not allow integers end with `_`
...
function _g(e, t) {
  ...
  if (isNaN(e))
    ...
    return "-0.0";
  return n = e.toString(10), vg.test(n) ? n.replace("e", ".e") : n;
}
function Ag(e) {
  return Object.prototype.toString.call(e) === "[object Number]" && (e % 1 !== 0 || hu.isNegativeZero(e));
}
var pu = new gg("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: yg,
  construct: wg,
  predicate: Ag,
...
}), gu = mu, Sg = Ue, Eu = new RegExp(
  "^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"
), yu = new RegExp(
  "^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$"
);
function Tg(e) {
  return e === null ? !1 : Eu.exec(e) !== null || yu.exec(e) !== null;
}
function Cg(e) {
  var t, n, r, i, o, a, s, l = 0, p = null, c, f, h;
  if (t = Eu.exec(e), t === null && (t = yu.exec(e)), t === null) throw new Error("Date resolve error");
...
var vu = new bg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: Ig
}), Rg = Ue, ga = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function Og(e) {
  if (e === null) return !1;
...
var _u = new Rg("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: Og,
  construct: Pg,
  predicate: Ng,
  represent: Dg
}), Fg = Ue, xg = Object.prototype.hasOwnProperty, Lg = Object.prototype.toString;
function Ug(e) {
  if (e === null) return !0;
  var t = [], n, r, i, o, a, s = e;
  for (n = 0, r = s.length; n < r; n += 1) {
    if (i = s[n], a = !1, Lg.call(i) !== "[object Object]") return !1;
    for (o in i)
      if (xg.call(i, o))
        if (!a) a = !0;
        else return !1;
...
var Au = new Fg("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: Ug,
  construct: kg
}), Mg = Ue, Bg = Object.prototype.toString;
function jg(e) {
  if (e === null) return !0;
  var t, n, r, i, o, a = e;
  for (o = new Array(a.length), t = 0, n = a.length; t < n; t += 1) {
    if (r = a[t], Bg.call(r) !== "[object Object]" || (i = Object.keys(r), i.length !== 1)) return !1;
    o[t] = [i[0], r[i[0]]];
  }
  return !0;
}
...
var Su = new Mg("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: jg,
  construct: Hg
}), Gg = Ue, qg = Object.prototype.hasOwnProperty;
function Wg(e) {
  if (e === null) return !0;
  var t, n = e;
  for (t in n)
    if (qg.call(n, t) && n[t] !== null)
      return !1;
  return !0;
}
function Vg(e) {
...
var Tu = new Gg("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: Wg,
  construct: Vg
}), Ea = gu.extend({
...
}), Ht = Ze, Cu = gr, Yg = qm, zg = Ea, Ct = Object.prototype.hasOwnProperty, si = 1, $u = 2, bu = 3, li = 4, ro = 1, Xg = 2, Fs = 3, Kg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Jg = /[\x85\u2028\u2029]/, Qg = /[,\[\]\{\}]/, Iu = /^(?:!|!!|![a-z\-]+!)$/i, Ru = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function xs(e) {
...
var Pu = new Array(256), Du = new Array(256);
for (var rn = 0; rn < 256; rn++)
  Pu[rn] = Ls(rn) ? 1 : 0, Du[rn] = Ls(rn);
function r0(e, t) {
...
function Nu(e, t) {
  ...
  return n.snippet = Yg(n), new Cu(t, n);
}
function U(e, t) {
  throw Nu(e, t);
}
...
var Us = {
  ...
  TAG: function(t, n, r) {
    var i, o;
    r.length !== 2 && U(t, "TAG directive accepts exactly two arguments"), i = r[0], o = r[1], Iu.test(i) || U(t, "ill-formed tag handle (first argument) of the TAG directive"), Ct.call(t.tagMap, i) && U(t, 'there is a previously declared suffix for "' + i + '" tag handle'), Ru.test(o) || U(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function At(e, t, n, r) {
  ...
  if (t < n) {
    ...
    else Kg.test(s) && U(e, "the stream contains non-printable characters");
    e.result += s;
  }
}
function ks(e, t, n, r) {
  ...
  for (Ht.isObject(n) || U(e, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(n), a = 0, s = i.length; a < s; a += 1)
    o = i[a], Ct.call(t, o) || (Ou(t, o, n[o]), r[o] = !0);
}
function fn(e, t, n, r, i, o, a, s, l) {
  ...
  if (typeof i == "object" && xs(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), r === "tag:yaml.org,2002:merge")
    ...
    !e.json && !Ct.call(n, i) && Ct.call(t, i) && (e.line = a || e.line, e.lineStart = s || e.lineStart, e.position = l || e.position, U(e, "duplicated mapping key")), Ou(t, i, o), delete n[i];
  return t;
}
function ya(e) {
  var t;
...
function i0(e, t, n) {
  ...
  if (m = e.input.charCodeAt(e.position), Be(m) || un(m) || m === 35 || m === 38 || m === 42 || m === 33 || m === 124 || m === 62 || m === 39 || m === 34 || m === 37 || m === 64 || m === 96 || (m === 63 || m === 45) && (i = e.input.charCodeAt(e.position + 1), Be(i) || n && un(i)))
    return !1;
  for (e.kind = "scalar", e.result = "", o = a = e.position, s = !1; m !== 0; ) {
    if (m === 58) {
      if (i = e.input.charCodeAt(e.position + 1), Be(i) || n && un(i))
        break;
    } else if (m === 35) {
    ...
    s && (At(e, o, a, !1), wa(e, e.line - l), o = a = e.position, s = !1), Yt(m) || (a = e.position + 1), m = e.input.charCodeAt(++e.position);
  }
  return At(e, o, a, !1), e.result ? !0 : (e.kind = f, e.result = h, !1);
}
function o0(e, t) {
  var n, r, i;
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = i = e.position; (n = e.input.charCodeAt(e.position)) !== 0; )
    if (n === 39)
      if (At(e, r, e.position, !0), n = e.input.charCodeAt(++e.position), n === 39)
        ...
        return !0;
    else at(n) ? (At(e, r, i, !0), wa(e, ue(e, !1, t)), r = i = e.position) : e.position === e.lineStart && _i(e) ? U(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function a0(e, t) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = r = e.position; (s = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (s === 92) {
      if (At(e, n, e.position, !0), s = e.input.charCodeAt(++e.position), at(s))
        ue(e, !1, t);
      else if (s < 256 && Pu[s])
        ...
        e.result += n0(o), e.position++;
      } else
        U(e, "unknown escape sequence");
      n = r = e.position;
    } else at(s) ? (At(e, n, r, !0), wa(e, ue(e, !1, t)), n = r = e.position) : e.position === e.lineStart && _i(e) ? U(e, "unexpected end of the document within a double quoted scalar") : (e.position++, r = e.position);
  }
...
function s0(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = s), T = e.input.charCodeAt(++e.position); T !== 0; ) {
    ...
    n ? T === 44 && U(e, "expected the node content, but found ','") : U(e, "missed comma between flow collection entries"), A = E = C = null, f = h = !1, T === 63 && (p = e.input.charCodeAt(e.position + 1), Be(p) && (f = h = !0, e.position++, ue(e, !0, t))), r = e.line, i = e.lineStart, o = e.position, _n(e, t, si, !1, !0), A = e.tag, E = e.result, ue(e, !0, t), T = e.input.charCodeAt(e.position), (h || e.line === r) && T === 58 && (f = !0, T = e.input.charCodeAt(++e.position), ue(e, !0, t), _n(e, t, si, !1, !0), C = e.result), m ? fn(e, s, y, A, E, C, r, i, o) : f ? s.push(fn(e, null, y, A, E, C, r, i, o)) : s.push(E), ue(e, !0, t), T = e.input.charCodeAt(e.position), T === 44 ? (n = !0, T = e.input.charCodeAt(++e.position)) : n = !1;
  }
...
function l0(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; f !== 0; )
    if (f = e.input.charCodeAt(++e.position), f === 43 || f === 45)
      ro === i ? i = f === 43 ? Fs : Xg : U(e, "repeat of a chomping mode identifier");
    else if ((c = t0(f)) >= 0)
...
function Ms(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), l = e.input.charCodeAt(e.position); l !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, U(e, "tab characters must not be used in indentation")), !(l !== 45 || (a = e.input.charCodeAt(e.position + 1), !Be(a)))); ) {
    ...
    if (n = e.line, _n(e, t, bu, !1, !0), o.push(e.result), ue(e, !0, -1), l = e.input.charCodeAt(e.position), (e.line === n || e.lineIndent > t) && l !== 0)
...
function c0(e, t, n) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = f), T = e.input.charCodeAt(e.position); T !== 0; ) {
    if (!A && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, U(e, "tab characters must not be used in indentation")), r = e.input.charCodeAt(e.position + 1), o = e.line, (T === 63 || T === 58) && Be(r))
      T === 63 ? (A && (fn(e, f, h, m, y, null, a, s, l), m = y = E = null), C = !0, A = !0, i = !0) : A ? (A = !1, i = !0) : U(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, T = r;
    else {
      if (a = e.line, s = e.lineStart, l = e.position, !_n(e, n, $u, !1, !0))
        break;
      if (e.line === o) {
        for (T = e.input.charCodeAt(e.position); Yt(T); )
          T = e.input.charCodeAt(++e.position);
        if (T === 58)
          T = e.input.charCodeAt(++e.position), Be(T) || U(e, "a whitespace character is expected after the key-value separator within a block mapping"), A && (fn(e, f, h, m, y, null, a, s, l), m = y = E = null), C = !0, A = !1, i = !1, m = e.tag, y = e.result;
        else if (C)
    ...
    if ((e.line === o || e.lineIndent > t) && (A && (a = e.line, s = e.lineStart, l = e.position), _n(e, t, li, !0, i) && (A ? y = e.result : E = e.result), A || (fn(e, f, h, m, y, E, a, s, l), m = y = E = null), ue(e, !0, -1), T = e.input.charCodeAt(e.position)), (e.line === o || e.lineIndent > t) && T !== 0)
      U(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return A && fn(e, f, h, m, y, null, a, s, l), C && (e.tag = p, e.anchor = c, e.kind = "mapping", e.result = f), C;
}
function u0(e) {
  var t, n = !1, r = !1, i, o, a;
  ...
  if (e.tag !== null && U(e, "duplication of a tag property"), a = e.input.charCodeAt(++e.position), a === 60 ? (n = !0, a = e.input.charCodeAt(++e.position)) : a === 33 ? (r = !0, i = "!!", a = e.input.charCodeAt(++e.position)) : i = "!", t = e.position, n) {
    ...
    for (; a !== 0 && !Be(a); )
      a === 33 && (r ? U(e, "tag suffix cannot contain exclamation marks") : (i = e.input.slice(t - 1, e.position + 1), Iu.test(i) || U(e, "named tag handle cannot contain such characters"), r = !0, t = e.position + 1)), a = e.input.charCodeAt(++e.position);
    o = e.input.slice(t, e.position), Qg.test(o) && U(e, "tag suffix cannot contain flow indicator characters");
  }
  o && !Ru.test(o) && U(e, "tag name cannot contain such characters: " + o);
  try {
    o = decodeURIComponent(o);
  } catch {
...
function f0(e) {
  ...
  for (e.anchor !== null && U(e, "duplication of an anchor property"), n = e.input.charCodeAt(++e.position), t = e.position; n !== 0 && !Be(n) && !un(n); )
...
function d0(e) {
  ...
  for (r = e.input.charCodeAt(++e.position), t = e.position; r !== 0 && !Be(r) && !un(r); )
...
function _n(e, t, n, r, i) {
  ...
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, o = a = s = li === n || bu === n, r && ue(e, !0, -1) && (p = !0, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)), l === 1)
    for (; u0(e) || f0(e); )
      ue(e, !0, -1) ? (p = !0, s = o, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)) : s = !1;
  if (s && (s = p || i), (l === 1 || li === n) && (si === n || $u === n ? E = t : E = t + 1, A = e.position - e.lineStart, l === 1 ? s && (Ms(e, A) || c0(e, A, E)) || s0(e, E) ? c = !0 : (a && l0(e, E) || o0(e, E) || a0(e, E) ? c = !0 : d0(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && U(e, "alias node should not have any properties")) : i0(e, E, si === n) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = s && Ms(e, A))), e.tag === null)
...
function h0(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (a = e.input.charCodeAt(e.position)) !== 0 && (ue(e, !0, -1), a = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || a !== 37)); ) {
    ...
    a !== 0 && ya(e), Ct.call(Us, r) ? Us[r](e, r, i) : ci(e, 'unknown document directive "' + r + '"');
  }
  if (ue(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, ue(e, !0, -1)) : o && U(e, "directives end mark is expected"), _n(e, e.lineIndent - 1, li, !1, !0), ue(e, !0, -1), e.checkLineBreaks && Jg.test(e.input.slice(t, e.position)) && ci(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && _i(e)) {
...
`), e.charCodeAt(0) === 65279 && (e = e.slice(1)));
  var n = new r0(e, t), r = e.indexOf("\0");
...
ma.loadAll = p0;
ma.load = m0;
var xu = {}, Ai = Ze, Er = gr, g0 = Ea, Lu = Object.prototype.toString, Uu = Object.prototype.hasOwnProperty, va = 65279, E0 = 9, Zn = 10, y0 = 13, w0 = 32, v0 = 33, _0 = 34, ko = 35, A0 = 37, S0 = 38, T0 = 39, C0 = 42, ku = 44, $0 = 45, ui = 58, b0 = 61, I0 = 62, R0 = 63, O0 = 64, Mu = 91, Bu = 93, P0 = 96, ju = 123, D0 = 124, Hu = 125, be = {};
be[0] = "\\0";
be[7] = "\\a";
be[8] = "\\b";
be[9] = "\\t";
...
function x0(e, t) {
  ...
  for (n = {}, r = Object.keys(t), i = 0, o = r.length; i < o; i += 1)
    a = r[i], s = String(t[a]), a.slice(0, 2) === "!!" && (a = "tag:yaml.org,2002:" + a.slice(2)), l = e.compiledTypeMap.fallback[a], l && Uu.call(l.styleAliases, s) && (s = l.styleAliases[s]), n[a] = s;
  return n;
}
function L0(e) {
  var t, n, r;
...
var U0 = 1, er = 2;
function k0(e) {
  this.schema = e.schema || g0, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = Ai.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = x0(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? er : U0, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function Bs(e, t) {
...
function Hs(e, t, n) {
  ...
  return (
    ...
    (n ? (
      // c = flow-in
      r
    ) : r && e !== ku && e !== Mu && e !== Bu && e !== ju && e !== Hu) && e !== ko && !(t === ui && !i) || js(t) && !fi(t) && e === ko || t === ui && i
  );
}
function B0(e) {
  return tr(e) && e !== va && !fi(e) && e !== $0 && e !== R0 && e !== ui && e !== ku && e !== Mu && e !== Bu && e !== ju && e !== Hu && e !== ko && e !== S0 && e !== C0 && e !== v0 && e !== D0 && e !== b0 && e !== I0 && e !== T0 && e !== _0 && e !== A0 && e !== O0 && e !== P0;
}
function j0(e) {
  return !fi(e) && e !== ui;
}
...
var qu = 1, Bo = 2, Wu = 3, Vu = 4, ln = 5;
function H0(e, t, n, r, i, o, a, s) {
  var l, p = 0, c = null, f = !1, h = !1, m = r !== -1, y = -1, E = B0(Hn(e, 0)) && j0(Hn(e, e.length - 1));
  if (t || a)
  ...
  return !f && !h ? E && !a && !i(e) ? qu : o === er ? ln : Bo : n > 9 && Gu(e) ? ln : a ? o === er ? ln : Bo : h ? Vu : Wu;
}
function G0(e, t, n, r, i) {
  e.dump = function() {
    if (t.length === 0)
      return e.quotingType === er ? '""' : "''";
    if (!e.noCompatMode && (N0.indexOf(t) !== -1 || F0.test(t)))
    ...
    switch (H0(
      ...
      case Vu:
        return ">" + Gs(t, e.indent) + qs(Bs(q0(t, a), o));
      case ln:
        return '"' + W0(t) + '"';
      default:
...
function Gs(e, t) {
  var n = Gu(e) ? String(t) : "", r = e[e.length - 1] === `
`, i = r && (e[e.length - 2] === `
` || e === `
`), o = i ? "+" : r ? "" : "-";
  return n + o + `
...
function W0(e) {
  for (var t = "", n = 0, r, i = 0; i < e.length; n >= 65536 ? i += 2 : i++)
    n = Hn(e, i), r = be[n], !r && tr(n) ? (t += e[i], n >= 65536 && (t += e[i + 1])) : t += r || L0(n);
  return t;
}
function V0(e, t, n) {
  var r = "", i = e.tag, o, a, s;
...
function ht(e, t, n, r, i, o, a) {
  ...
  if (c && (f = e.duplicates.indexOf(n), h = f !== -1), (e.tag !== null && e.tag !== "?" || h || e.indent !== 2 && t > 0) && (i = !1), h && e.usedDuplicates[f])
    ...
    if (c && h && !e.usedDuplicates[f] && (e.usedDuplicates[f] = !0), s === "[object Object]")
      r && Object.keys(e.dump).length !== 0 ? (z0(e, t, e.dump, i), h && (e.dump = "&ref_" + f + e.dump)) : (Y0(e, t, e.dump), h && (e.dump = "&ref_" + f + " " + e.dump));
    else if (s === "[object Array]")
      r && e.dump.length !== 0 ? (e.noArrayIndent && !a && t > 0 ? Vs(e, t - 1, e.dump, i) : Vs(e, t, e.dump, i), h && (e.dump = "&ref_" + f + e.dump)) : (V0(e, t, e.dump), h && (e.dump = "&ref_" + f + " " + e.dump));
    else if (s === "[object String]")
      e.tag !== "?" && G0(e, e.dump, t, o, l);
    else {
...
we.Type = Ue;
we.Schema = ou;
we.FAILSAFE_SCHEMA = cu;
we.JSON_SCHEMA = mu;
we.CORE_SCHEMA = gu;
we.DEFAULT_SCHEMA = Ea;
we.load = Yu.load;
we.loadAll = Yu.loadAll;
we.dump = J0.dump;
we.YAMLException = gr;
we.types = {
  binary: _u,
...
Si.Lazy = Q0;
var Ho = { exports: {} };
const Z0 = "2.0.0", zu = 256, eE = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, tE = 16, nE = zu - 6, rE = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
(function(e, t) {
  ...
  const h = "[a-zA-Z0-9-]", m = [
    ...
    const N = y(C), k = f++;
    o(A, k, C), c[A] = k, l[k] = C, p[k] = N, a[k] = new RegExp(C, T ? "g" : void 0), s[k] = new RegExp(N, T ? "g" : void 0);
  };
...
var yr = Ho.exports;
const oE = Object.freeze({ loose: !0 }), aE = Object.freeze({}), sE = (e) => e ? typeof e != "object" ? oE : e : aE;
var Aa = sE;
const zs = /^[0-9]+$/, Xu = (e, t) => {
...
const Mr = Ci, { MAX_LENGTH: Xs, MAX_SAFE_INTEGER: Br } = Ti, { safeRe: jr, t: Hr } = yr, cE = Aa, { compareIdentifiers: io } = Ku;
let uE = class it {
  constructor(t, n) {
    if (n = cE(n), t instanceof it) {
...
var pE = hE;
const mE = Cn, gE = (e, t) => {
  const n = mE(e.trim().replace(/^[=v]+/, ""), t);
  return n ? n.version : null;
};
var EE = gE;
const Js = ke, yE = (e, t, n, r, i) => {
...
var _E = vE;
const AE = ke, SE = (e, t) => new AE(e, t).major;
var TE = SE;
const CE = ke, $E = (e, t) => new CE(e, t).minor;
var bE = $E;
const IE = ke, RE = (e, t) => new IE(e, t).patch;
var OE = RE;
const PE = Cn, DE = (e, t) => {
  const n = PE(e, t);
...
var NE = DE;
const Zs = ke, FE = (e, t, n) => new Zs(e, n).compare(new Zs(t, n));
var et = FE;
const xE = et, LE = (e, t, n) => xE(t, e, n);
var UE = LE;
const kE = et, ME = (e, t) => kE(e, t, !0);
var BE = ME;
const el = ke, jE = (e, t, n) => {
  const r = new el(e, n), i = new el(t, n);
  return r.compare(i) || r.compareBuild(i);
};
var Sa = jE;
const HE = Sa, GE = (e, t) => e.sort((n, r) => HE(n, r, t));
var qE = GE;
const WE = Sa, VE = (e, t) => e.sort((n, r) => WE(r, n, t));
var YE = VE;
const zE = et, XE = (e, t, n) => zE(e, t, n) > 0;
var $i = XE;
const KE = et, JE = (e, t, n) => KE(e, t, n) < 0;
var Ta = JE;
const QE = et, ZE = (e, t, n) => QE(e, t, n) === 0;
var Ju = ZE;
const ey = et, ty = (e, t, n) => ey(e, t, n) !== 0;
var Qu = ty;
const ny = et, ry = (e, t, n) => ny(e, t, n) >= 0;
var Ca = ry;
const iy = et, oy = (e, t, n) => iy(e, t, n) <= 0;
var $a = oy;
const ay = Ju, sy = Qu, ly = $i, cy = Ca, uy = Ta, fy = $a, dy = (e, t, n, r) => {
  switch (t) {
    case "===":
...
var Zu = dy;
const hy = ke, py = Cn, { safeRe: Gr, t: qr } = yr, my = (e, t) => {
  if (e instanceof hy)
    return e;
...
function tt() {
  ...
  class t {
    ...
    parseRange(I) {
      const b = ((this.options.includePrerelease && m) | (this.options.loose && y)) + ":" + I, D = r.get(b);
      if (D)
        return D;
    ...
    intersects(I, P) {
      ...
      return this.set.some((b) => C(b, P) && I.set.some((D) => C(D, P) && b.every((O) => D.every((M) => O.intersects(M, P)))));
    }
  ...
  oo = t;
  const n = yy, r = new n(), i = Aa, o = bi(), a = Ci, s = ke, {
    safeRe: l,
    t: p,
    ...
    let D = b.pop();
    for (; P && b.length; )
      P = b.every((O) => D.intersects(O, I)), D = b.pop();
    return P;
  }, T = (R, I) => (R = R.replace(l[p.BUILD], ""), a("comp", R, I), R = K(R, I), a("caret", R), R = k(R, I), a("tildes", R), R = te(R, I), a("xrange", R), R = w(R, I), a("stars", R), R), N = (R) => !R || R.toLowerCase() === "x" || R === "*", k = (R, I) => R.trim().split(/\s+/).map((P) => q(P, I)).join(" "), q = (R, I) => {
    const P = I.loose ? l[p.TILDELOOSE] : l[p.TILDE];
    return R.replace(P, (b, D, O, M, W) => {
      a("tilde", R, b, D, O, M, W);
      let F;
      return N(D) ? F = "" : N(O) ? F = `>=${D}.0.0 <${+D + 1}.0.0-0` : N(M) ? F = `>=${D}.${O}.0 <${D}.${+O + 1}.0-0` : W ? (a("replaceTilde pr", W), F = `>=${D}.${O}.${M}-${W} <${D}.${+O + 1}.0-0`) : F = `>=${D}.${O}.${M} <${D}.${+O + 1}.0-0`, a("tilde return", F), F;
    });
  }, K = (R, I) => R.trim().split(/\s+/).map((P) => Z(P, I)).join(" "), Z = (R, I) => {
    a("caret", R, I);
    const P = I.loose ? l[p.CARETLOOSE] : l[p.CARET], b = I.includePrerelease ? "-0" : "";
    return R.replace(P, (D, O, M, W, F) => {
      a("caret", R, D, O, M, W, F);
      let J;
      return N(O) ? J = "" : N(M) ? J = `>=${O}.0.0${b} <${+O + 1}.0.0-0` : N(W) ? O === "0" ? J = `>=${O}.${M}.0${b} <${O}.${+M + 1}.0-0` : J = `>=${O}.${M}.0${b} <${+O + 1}.0.0-0` : F ? (a("replaceCaret pr", F), O === "0" ? M === "0" ? J = `>=${O}.${M}.${W}-${F} <${O}.${M}.${+W + 1}-0` : J = `>=${O}.${M}.${W}-${F} <${O}.${+M + 1}.0-0` : J = `>=${O}.${M}.${W}-${F} <${+O + 1}.0.0-0`) : (a("no pr"), O === "0" ? M === "0" ? J = `>=${O}.${M}.${W}${b} <${O}.${M}.${+W + 1}-0` : J = `>=${O}.${M}.${W}${b} <${O}.${+M + 1}.0-0` : J = `>=${O}.${M}.${W} <${+O + 1}.0.0-0`), a("caret return", J), J;
    });
  }, te = (R, I) => (a("replaceXRanges", R, I), R.split(/\s+/).map((P) => L(P, I)).join(" ")), L = (R, I) => {
    R = R.trim();
    const P = I.loose ? l[p.XRANGELOOSE] : l[p.XRANGE];
    return R.replace(P, (b, D, O, M, W, F) => {
      a("xRange", R, b, D, O, M, W, F);
      const J = N(O), de = J || N(M), B = de || N(W), ve = B;
      return D === "=" && ve && (D = ""), F = I.includePrerelease ? "-0" : "", J ? D === ">" || D === "<" ? b = "<0.0.0-0" : b = "*" : D && ve ? (de && (M = 0), W = 0, D === ">" ? (D = ">=", de ? (O = +O + 1, M = 0, W = 0) : (M = +M + 1, W = 0)) : D === "<=" && (D = "<", de ? O = +O + 1 : M = +M + 1), D === "<" && (F = "-0"), b = `${D + O}.${M}.${W}${F}`) : de ? b = `>=${O}.0.0${F} <${+O + 1}.0.0-0` : B && (b = `>=${O}.${M}.0${F} <${O}.${+M + 1}.0-0`), a("xRange return", b), b;
    });
  }, w = (R, I) => (a("replaceStars", R, I), R.trim().replace(l[p.STAR], "")), G = (R, I) => (a("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? p.GTE0PRE : p.GTE0], "")), z = (R) => (I, P, b, D, O, M, W, F, J, de, B, ve) => (N(b) ? P = "" : N(D) ? P = `>=${b}.0.0${R ? "-0" : ""}` : N(O) ? P = `>=${b}.${D}.0${R ? "-0" : ""}` : M ? P = `>=${P}` : P = `>=${P}${R ? "-0" : ""}`, N(J) ? F = "" : N(de) ? F = `<${+J + 1}.0.0-0` : N(B) ? F = `<${J}.${+de + 1}.0-0` : ve ? F = `<=${J}.${de}.${B}-${ve}` : R ? F = `<${J}.${de}.${+B + 1}-0` : F = `<=${F}`, `${P} ${F}`.trim()), ne = (R, I, P) => {
    ...
    if (I.prerelease.length && !P.includePrerelease) {
      for (let b = 0; b < R.length; b++)
        if (a(R[b].semver), R[b].semver !== o.ANY && R[b].semver.prerelease.length > 0) {
          const D = R[b].semver;
          if (D.major === I.major && D.minor === I.minor && D.patch === I.patch)
            return !0;
        }
      return !1;
    }
...
function bi() {
  ...
  ao = t;
  const n = Aa, { safeRe: r, t: i } = yr, o = Zu, a = Ci, s = ke, l = tt();
  return ao;
}
const wy = tt(), vy = (e, t, n) => {
  try {
    t = new wy(t, n);
  } catch {
    return !1;
...
var Ii = vy;
const _y = tt(), Ay = (e, t) => new _y(e, t).set.map((n) => n.map((r) => r.value).join(" ").trim().split(" "));
var Sy = Ay;
const Ty = ke, Cy = tt(), $y = (e, t, n) => {
...
const Iy = ke, Ry = tt(), Oy = (e, t, n) => {
  ...
  return e.forEach((a) => {
    o.test(a) && (!r || i.compare(a) === 1) && (r = a, i = new Iy(r, n));
  }), r;
};
var Py = Oy;
const so = ke, Dy = tt(), rl = $i, Ny = (e, t) => {
  e = new Dy(e, t);
  let n = new so("0.0.0");
...
const xy = tt(), Ly = (e, t) => {
  try {
    return new xy(e, t).range || "*";
  } catch {
    return null;
  }
};
var Uy = Ly;
const ky = ke, ef = bi(), { ANY: My } = ef, By = tt(), jy = Ii, il = $i, ol = Ta, Hy = $a, Gy = Ca, qy = (e, t, n, r) => {
  e = new ky(e, r), t = new By(t, r);
  let i, o, a, s, l;
  switch (n) {
    case ">":
      i = il, o = Hy, a = ol, s = ">", l = ">=";
  ...
  for (let p = 0; p < t.set.length; ++p) {
    ...
    let f = null, h = null;
    if (c.forEach((m) => {
      m.semver === My && (m = new ef(">=0.0.0")), f = f || m, h = h || m, i(m.semver, f.semver, r) ? f = m : a(m.semver, h.semver, r) && (h = m);
...
var ba = qy;
const Wy = ba, Vy = (e, t, n) => Wy(e, t, ">", n);
var Yy = Vy;
const zy = ba, Xy = (e, t, n) => zy(e, t, "<", n);
var Ky = Xy;
const al = tt(), Jy = (e, t, n) => (e = new al(e, n), t = new al(t, n), e.intersects(t, n));
var Qy = Jy;
const Zy = Ii, ew = et;
var tw = (e, t, n) => {
  const r = [];
  let i = null, o = null;
  const a = e.sort((c, f) => ew(c, f, n));
  for (const c of a)
...
const sl = tt(), Ia = bi(), { ANY: lo } = Ia, Ln = Ii, Ra = et, nw = (e, t, n = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, rw = [new Ia(">=0.0.0-0")], ll = [new Ia(">=0.0.0")], iw = (e, t, n) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === lo) {
    if (t.length === 1 && t[0].semver === lo)
      return !0;
    n.includePrerelease ? e = rw : e = ll;
  }
  if (t.length === 1 && t[0].semver === lo) {
...
var ow = nw;
const co = yr, fl = Ti, aw = ke, dl = Ku, sw = Cn, lw = pE, cw = EE, uw = wE, fw = _E, dw = TE, hw = bE, pw = OE, mw = NE, gw = et, Ew = UE, yw = BE, ww = Sa, vw = qE, _w = YE, Aw = $i, Sw = Ta, Tw = Ju, Cw = Qu, $w = Ca, bw = $a, Iw = Zu, Rw = gy, Ow = bi(), Pw = tt(), Dw = Ii, Nw = Sy, Fw = by, xw = Py, Lw = Fy, Uw = Uy, kw = ba, Mw = Yy, Bw = Ky, jw = Qy, Hw = tw, Gw = ow;
var tf = {
  parse: sw,
  valid: lw,
  clean: cw,
...
di.exports;
(function(e, t) {
  var n = 200, r = "__lodash_hash_undefined__", i = 1, o = 2, a = 9007199254740991, s = "[object Arguments]", l = "[object Array]", p = "[object AsyncFunction]", c = "[object Boolean]", f = "[object Date]", h = "[object Error]", m = "[object Function]", y = "[object GeneratorFunction]", E = "[object Map]", A = "[object Number]", C = "[object Null]", T = "[object Object]", N = "[object Promise]", k = "[object Proxy]", q = "[object RegExp]", K = "[object Set]", Z = "[object String]", te = "[object Symbol]", L = "[object Undefined]", w = "[object WeakMap]", G = "[object ArrayBuffer]", z = "[object DataView]", ne = "[object Float32Array]", R = "[object Float64Array]", I = "[object Int8Array]", P = "[object Int16Array]", b = "[object Int32Array]", D = "[object Uint8Array]", O = "[object Uint8ClampedArray]", M = "[object Uint16Array]", W = "[object Uint32Array]", F = /[\\^$.*+?()[\]{}|]/g, J = /^\[object .+?Constructor\]$/, de = /^(?:0|[1-9]\d*)$/, B = {};
  B[ne] = B[R] = B[I] = B[P] = B[b] = B[D] = B[O] = B[M] = B[W] = !0, B[s] = B[l] = B[G] = B[c] = B[z] = B[f] = B[h] = B[m] = B[E] = B[A] = B[T] = B[q] = B[K] = B[Z] = B[w] = !1;
  var ve = typeof Pe == "object" && Pe && Pe.Object === Object && Pe, In = typeof self == "object" && self && self.Object === Object && self, Ve = ve || In || Function("return this")(), Rn = t && !t.nodeType && t, en = Rn && !0 && e && !e.nodeType && e, Tr = en && en.exports === Rn, d = Tr && ve.process, u = function() {
    try {
  ...
  var Cr = Array.prototype, On = Function.prototype, Dt = Object.prototype, Mi = Ve["__core-js_shared__"], La = On.toString, rt = Dt.hasOwnProperty, Ua = function() {
    var g = /[^.]+$/.exec(Mi && Mi.keys && Mi.keys.IE_PROTO || "");
    return g ? "Symbol(src)_1." + g : "";
  }(), ka = Dt.toString, Af = RegExp(
    "^" + La.call(rt).replace(F, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Ma = Tr ? Ve.Buffer : void 0, $r = Ve.Symbol, Ba = Ve.Uint8Array, ja = Dt.propertyIsEnumerable, Sf = Cr.splice, Nt = $r ? $r.toStringTag : void 0, Ha = Object.getOwnPropertySymbols, Tf = Ma ? Ma.isBuffer : void 0, Cf = ze(Object.keys, Object), Bi = tn(Ve, "DataView"), Pn = tn(Ve, "Map"), ji = tn(Ve, "Promise"), Hi = tn(Ve, "Set"), Gi = tn(Ve, "WeakMap"), Dn = tn(Object, "create"), $f = Lt(Bi), bf = Lt(Pn), If = Lt(ji), Rf = Lt(Hi), Of = Lt(Gi), Ga = $r ? $r.prototype : void 0, qi = Ga ? Ga.valueOf : void 0;
  function Ft(g) {
  ...
  function Ff(g) {
    var _ = this.__data__;
    return Dn ? _[g] !== void 0 : rt.call(_, g);
  }
  function xf(g, _) {
    var $ = this.__data__;
    return this.size += this.has(g) ? 0 : 1, $[g] = Dn && _ === void 0 ? r : _, this;
  }
  Ft.prototype.clear = Pf, Ft.prototype.delete = Df, Ft.prototype.get = Nf, Ft.prototype.has = Ff, Ft.prototype.set = xf;
  function lt(g) {
    var _ = -1, $ = g == null ? 0 : g.length;
    for (this.clear(); ++_ < $; ) {
      var x = g[_];
  ...
  xt.prototype.clear = jf, xt.prototype.delete = Hf, xt.prototype.get = Gf, xt.prototype.has = qf, xt.prototype.set = Wf;
  function br(g) {
    var _ = -1, $ = g == null ? 0 : g.length;
  ...
  br.prototype.add = br.prototype.push = Vf, br.prototype.has = Yf;
  function pt(g) {
  ...
  pt.prototype.clear = zf, pt.prototype.delete = Xf, pt.prototype.get = Kf, pt.prototype.has = Jf, pt.prototype.set = Qf;
  function Zf(g, _) {
    var $ = Or(g), x = !$ && pd(g), ee = !$ && !x && Wi(g), j = !$ && !x && !ee && Qa(g), se = $ || x || ee || j, me = se ? le(g.length, String) : [], Ee = me.length;
    for (var ie in g)
  ...
  function Nn(g) {
    return g == null ? g === void 0 ? L : C : Nt && Nt in Object(g) ? sd(g) : hd(g);
  }
  function qa(g) {
    return Fn(g) && Nn(g) == s;
  }
  function Wa(g, _, $, x, ee) {
    return g === _ ? !0 : g == null || _ == null || !Fn(g) && !Fn(_) ? g !== g && _ !== _ : td(g, _, $, x, Wa, ee);
  }
  function td(g, _, $, x, ee, j) {
    var se = Or(g), me = Or(_), Ee = se ? l : mt(g), ie = me ? l : mt(_);
    Ee = Ee == s ? T : Ee, ie = ie == s ? T : ie;
    var He = Ee == T, Xe = ie == T, Se = Ee == ie;
    if (Se && Wi(g)) {
      if (!Wi(_))
        return !1;
      se = !0, He = !1;
    ...
    if (Se && !He)
      return j || (j = new pt()), se || Qa(g) ? Va(g, _, $, x, ee, j) : od(g, _, Ee, $, x, ee, j);
    if (!($ & i)) {
    ...
    return Se ? (j || (j = new pt()), ad(g, _, $, x, ee, j)) : !1;
  }
  function nd(g) {
    if (!Ja(g) || fd(g))
      return !1;
  ...
  function rd(g) {
    return Fn(g) && Ka(g.length) && !!B[Nn(g)];
  }
  function id(g) {
    if (!dd(g))
      return Cf(g);
  ...
  function Va(g, _, $, x, ee, j) {
    ...
    if (ie && j.get(_))
      return ie == _;
    var He = -1, Xe = !0, Se = $ & o ? new br() : void 0;
    for (j.set(g, _), j.set(_, g); ++He < me; ) {
      ...
      if (Se) {
        if (!re(_, function(ct, Ut) {
          if (!Ae(Se, Ut) && (Ge === ct || ee(Ge, ct, $, x, j)))
            return Se.push(Ut);
        })) {
          Xe = !1;
          break;
  ...
  function od(g, _, $, x, ee, j, se) {
    switch ($) {
      ...
      case K:
        var Ee = x & i;
        if (me || (me = ki), g.size != _.size && !Ee)
          return !1;
        var ie = se.get(g);
        if (ie)
          return ie == _;
        x |= o, se.set(g, _);
        var He = Va(me(g), me(_), x, ee, j, se);
  ...
  function ad(g, _, $, x, ee, j) {
    var se = $ & i, me = Ya(g), Ee = me.length, ie = Ya(_), He = ie.length;
    if (Ee != He && !se)
      return !1;
    for (var Xe = Ee; Xe--; ) {
      var Se = me[Xe];
      if (!(se ? Se in _ : rt.call(_, Se)))
        return !1;
    }
    var Ge = j.get(g);
    if (Ge && j.get(_))
    ...
    for (var gt = se; ++Xe < Ee; ) {
      ...
      var ct = g[Se], Ut = _[Se];
      if (x)
        var Za = se ? x(Ut, ct, Se, _, g, j) : x(ct, Ut, Se, g, _, j);
      if (!(Za === void 0 ? ct === Ut || ee(ct, Ut, $, x, j) : Za)) {
        qe = !1;
        break;
      }
      gt || (gt = Se == "constructor");
    }
    if (qe && !gt) {
      var Pr = g.constructor, Dr = _.constructor;
      Pr != Dr && "constructor" in g && "constructor" in _ && !(typeof Pr == "function" && Pr instanceof Pr && typeof Dr == "function" && Dr instanceof Dr) && (qe = !1);
    }
  ...
  function Rr(g, _) {
    var $ = g.__data__;
    return ud(_) ? $[typeof _ == "string" ? "string" : "hash"] : $.map;
  }
  function tn(g, _) {
    var $ = Ye(g, _);
    return nd($) ? $ : void 0;
  ...
  function sd(g) {
    ...
    var ee = ka.call(g);
    return x && (_ ? g[Nt] = $ : delete g[Nt]), ee;
  }
  var ld = Ha ? function(g) {
    return g == null ? [] : (g = Object(g), v(Ha(g), function(_) {
      return ja.call(g, _);
    }));
  } : yd, mt = Nn;
  (Bi && mt(new Bi(new ArrayBuffer(1))) != z || Pn && mt(new Pn()) != E || ji && mt(ji.resolve()) != N || Hi && mt(new Hi()) != K || Gi && mt(new Gi()) != w) && (mt = function(g) {
    var _ = Nn(g), $ = _ == T ? g.constructor : void 0, x = $ ? Lt($) : "";
    if (x)
      switch (x) {
        case $f:
          return z;
...
wr.createTempUpdateFile = Xw;
const Ww = fr, Vw = It, hl = qw, Bt = Ot, Vn = ae;
class Yw {
  constructor(t) {
...
wr.DownloadedUpdateHelper = Yw;
function zw(e, t = "sha512", n = "base64", r) {
  return new Promise((i, o) => {
    const a = (0, Ww.createHash)(t);
    a.on("error", o).setEncoding(n), (0, Vw.createReadStream)(e, {
      ...r,
...
nt.newBaseUrl = ev;
nt.newUrlFromBase = tv;
nt.getChannelFilename = nv;
const rf = Rt;
function ev(e) {
  const t = new rf.URL(e);
  return t.pathname.endsWith("/") || (t.pathname += "/"), t;
}
function tv(e, t, n = !1) {
  const r = new rf.URL(e, t), i = t.search;
  return i != null && i.length !== 0 ? r.search = i : n && (r.search = `noCache=${Date.now().toString(32)}`), r;
}
function nv(e) {
  return `${e}.yml`;
}
var fe = {}, rv = "[object Symbol]", of = /[\\^$.*+?()[\]{}|]/g, iv = RegExp(of.source), ov = typeof Pe == "object" && Pe && Pe.Object === Object && Pe, av = typeof self == "object" && self && self.Object === Object && self, sv = ov || av || Function("return this")(), lv = Object.prototype, cv = lv.toString, ml = sv.Symbol, gl = ml ? ml.prototype : void 0, El = gl ? gl.toString : void 0;
function uv(e) {
  if (typeof e == "string")
    return e;
  if (dv(e))
...
function dv(e) {
  return typeof e == "symbol" || fv(e) && cv.call(e) == rv;
}
function hv(e) {
  return e == null ? "" : uv(e);
}
function pv(e) {
  return e = hv(e), e && iv.test(e) ? e.replace(of, "\\$&") : e;
}
var af = pv;
Object.defineProperty(fe, "__esModule", { value: !0 });
fe.Provider = void 0;
fe.findFile = wv;
fe.parseUpdateInfo = vv;
fe.getFileList = sf;
fe.resolveFiles = _v;
const $t = pe, mv = we, gv = Rt, hi = nt, Ev = af;
class yv {
  constructor(t) {
  ...
  getBlockMapFiles(t, n, r, i = null) {
    ...
    return [(0, hi.newUrlFromBase)(`${t.pathname.replace(new RegExp(Ev(r), "g"), n)}.blockmap`, i ? new gv.URL(i) : t), o];
  }
  ...
  async getLatestVersion() {
    ...
    for (let r = 0; ; r++)
      try {
        ...
        if (i instanceof yl.HttpError && i.statusCode === 404)
          throw (0, yl.newError)(`Cannot find channel "${t}" update info: ${i.stack || i.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND");
...
bt.computeReleaseNotes = cf;
const ft = pe, Gt = tf, Tv = Rt, dn = nt, Go = fe, go = /\/tag\/([^/]+)$/;
class lf extends Go.Provider {
  constructor(t, n, r) {
    super({
      ...r,
  ...
  async getLatestVersion() {
    ...
    try {
      if (this.updater.allowPrerelease) {
        const A = ((t = this.updater) === null || t === void 0 ? void 0 : t.channel) || ((n = Gt.prerelease(this.updater.currentVersion)) === null || n === void 0 ? void 0 : n[0]) || null;
        if (A === null)
          ...
          for (const C of l.getElements("entry")) {
            ...
            if (T === null)
              continue;
            const N = T[1], k = ((r = Gt.prerelease(N)) === null || r === void 0 ? void 0 : r[0]) || null, q = !A || ["alpha", "beta"].includes(A), K = k !== null && !["alpha", "beta"].includes(String(k));
        ...
        for (const A of l.getElements("entry"))
          if (go.exec(A.element("link").attribute("href"))[1] === c) {
            p = A;
            break;
          }
      }
...
${s}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    let f, h = "", m = "";
    const y = async (A) => {
      h = (0, dn.getChannelFilename)(A), m = (0, dn.newUrlFromBase)(this.getBaseDownloadPath(String(c), h), this.baseUrl);
    ...
    try {
      let A = this.channel;
      this.updater.allowPrerelease && (!((i = Gt.prerelease(c)) === null || i === void 0) && i[0]) && (A = this.getCustomChannelName(String((o = Gt.prerelease(c)) === null || o === void 0 ? void 0 : o[0]))), f = await y(A);
    } catch (A) {
      if (this.updater.allowPrerelease)
    ...
    const E = (0, Go.parseUpdateInfo)(f, h, m);
    return E.releaseName == null && (E.releaseName = p.elementValueOrEmpty("title")), E.releaseNotes == null && (E.releaseNotes = cf(this.updater.currentVersion, this.updater.fullChangelog, l, p)), {
      tag: c,
      ...E
    };
  }
  async getLatestTagName(t) {
    const n = this.options, r = n.host == null || n.host === "github.com" ? (0, dn.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new Tv.URL(`${this.computeGithubBasePath(`/repos/${n.owner}/${n.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
...
Di.GitLabProvider = void 0;
const Ie = pe, Eo = Rt, $v = af, Wr = nt, yo = fe;
class bv extends yo.Provider {
  /**
  ...
  async getLatestVersion() {
    const t = new Ie.CancellationToken(), n = (0, Wr.newUrlFromBase)(`projects/${this.options.projectId}/releases/permalink/latest`, this.baseApiUrl);
    let r;
    try {
    ...
    const l = async (h) => {
      ...
      s = new Eo.URL(m.direct_asset_url);
    ...
    const p = (0, yo.parseUpdateInfo)(o, a, s);
  ...
  async findBlockMapUrlsFromAssets(t, n, r) {
    ...
    if (s) {
      const l = r.replace(new RegExp($v(n), "g"), t);
  ...
  resolveFiles(t) {
    return (0, yo.getFileList)(t).map((n) => {
      const i = [
        n.url,
        // Original filename
...
Di.GitLabProvider = bv;
var Ni = {};
Object.defineProperty(Ni, "__esModule", { value: !0 });
Ni.KeygenProvider = void 0;
const _l = pe, wo = nt, vo = fe;
class Iv extends vo.Provider {
  constructor(t, n, r) {
    super({
      ...r,
      isUseMultipleRangeRequest: !1
...
Ni.KeygenProvider = Iv;
var Fi = {};
Object.defineProperty(Fi, "__esModule", { value: !0 });
Fi.PrivateGitHubProvider = void 0;
const on = pe, Rv = we, Ov = ae, Al = Rt, Sl = nt, Pv = bt, Dv = fe;
class Nv extends Pv.BaseGitHubProvider {
  constructor(t, n, r, i) {
  ...
  async getLatestVersion() {
    const t = new on.CancellationToken(), n = (0, Sl.getChannelFilename)(this.getDefaultChannelName()), r = await this.getLatestVersionInfo(t), i = r.assets.find((s) => s.name === n);
    if (i == null)
  ...
  resolveFiles(t) {
    return (0, Dv.getFileList)(t).map((n) => {
      const r = Ov.posix.basename(n.url).replace(/ /g, "-"), i = t.assets.find((o) => o != null && o.name === r);
      if (i == null)
...
Oi.isUrlProbablySupportMultiRangeRequests = uf;
Oi.createClient = Mv;
const Vr = pe, Fv = Pi, Tl = vr, xv = bt, Lv = Di, Uv = Ni, kv = Fi;
function uf(e) {
...
function Mv(e, t, n) {
  ...
  switch (r) {
    case "github": {
      ...
      return o == null ? new xv.GitHubProvider(i, t, n) : new kv.PrivateGitHubProvider(i, t, o, n);
    }
    case "bitbucket":
      return new Fv.BitbucketProvider(e, t, n);
    case "gitlab":
      return new Lv.GitLabProvider(e, t, n);
    case "keygen":
      return new Uv.KeygenProvider(e, t, n);
    case "s3":
    case "spaces":
...
function Bv(e, t, n) {
  ...
  const c = i.get(l);
  let f = 0;
  const { checksumToOffset: h, checksumToOldSize: m } = Hv(r.get(l), p.offset, n);
  let y = a.offset;
  for (let E = 0; E < c.checksums.length; y += c.sizes[E], E++) {
    const A = c.sizes[E], C = c.checksums[E];
    let T = h.get(C);
    T != null && m.get(C) !== A && (n.warn(`Checksum ("${C}") matches, but size differs (old: ${m.get(C)}, new: ${A})`), T = void 0), T === void 0 ? (f++, o != null && o.kind === qt.DOWNLOAD && o.end === y ? o.end += A : (o = {
      kind: qt.DOWNLOAD,
      start: y,
      end: y + A
      // oldBlocks: null,
    }, Cl(o, s, C, E))) : o != null && o.kind === qt.COPY && o.end === T ? o.end += A : (o = {
      kind: qt.COPY,
      start: T,
      end: T + A
      // oldBlocks: [checksum]
...
$n.copyData = ff;
const Yr = pe, Gv = It, qv = ur, Wv = Zt, bl = Buffer.from(`\r
\r
`);
var yt;
(function(e) {
  ...
  copyExistingData(t, n) {
    return new Promise((r, i) => {
      const o = () => {
        ...
        ff(a, this.out, this.options.oldFileFd, i, () => {
          t++, o();
        });
      };
      o();
...
function zv(e, t, n, r, i) {
  ...
  if (a <= 1) {
    const h = (m) => {
      ...
      const y = t.tasks[m++];
      if (y.kind === Rl.OperationKind.COPY)
        (0, Il.copyData)(y, n, t.oldFileFd, i, () => h(m));
      else {
  ...
  const f = e.httpExecutor.createRequest(c, (h) => {
    if (!Wo(h, i))
      return;
    const m = (0, qo.safeGetHeader)(h, "content-type"), y = /^multipart\/.+?\s*;\s*boundary=(?:"([^"]+)"|([^\s";]+))\s*$/i.exec(m);
    if (y == null) {
      i(new Error(`Content-Type "multipart/byteranges" is expected, but got "${m}"`));
      return;
    }
    const E = new Il.DataSplitter(n, t, l, y[1] || y[2], p, r, s, e.options.onProgress);
...
Ui.ProgressDifferentialDownloadCallbackTransform = Kv;
Object.defineProperty(_r, "__esModule", { value: !0 });
_r.DifferentialDownloader = void 0;
const Un = pe, _o = Ot, Jv = It, Qv = $n, Zv = Rt, zr = Zt, Ol = Li, e_ = Ui;
class t_ {
  ...
  async doDownloadFile(t, n) {
    ...
    await new Promise((a, s) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        p = new e_.ProgressDifferentialDownloadCallbackTransform(N, this.options.cancellationToken, this.options.onProgress), l.push(p);
      }
      ...
      A.redirect = "manual", m = (C) => {
        ...
        if (k.kind === zr.OperationKind.COPY) {
          p && p.beginFileCopy(), (0, Qv.copyData)(k, h, r, s, () => m(C));
          return;
        }
        ...
        K.on("redirect", (Z, te, L) => {
          this.logger.info(`Redirect to ${n_(L)}`), E = L, (0, Un.configureRequestUrl)(new Zv.URL(E), A), K.followRedirect();
...
xi.GenericDifferentialDownloader = i_;
var Pt = {};
(function(e) {
...
const Re = pe, o_ = fr, a_ = mi, s_ = nc, Ke = Ot, l_ = we, Ao = Si, Je = ae, jt = tf, Dl = wr, c_ = Ri, Nl = nf, u_ = vr, So = Oi, To = ic, f_ = xi, an = Pt;
class Pa extends s_.EventEmitter {
  /**
  ...
  constructor(t, n) {
    ...
    }), n == null ? (this.app = new c_.ElectronAppAdapter(), this.httpExecutor = new Nl.ElectronHttpExecutor((o, a) => this.emit("login", o, a))) : (this.app = n, this.httpExecutor = null);
    ...
    this.currentVersion = i, this.allowPrerelease = d_(i), t != null && (this.setFeedURL(t), typeof t != "string" && t.requestHeaders && (this.requestHeaders = t.requestHeaders));
  }
  //noinspection JSMethodCanBeStatic,JSUnusedGlobalSymbols
  getFeedURL() {
  ...
  setFeedURL(t) {
    ...
    let r;
    typeof t == "string" ? r = new u_.GenericProvider({ provider: "generic", url: t }, this, {
      ...n,
      isUseMultipleRangeRequest: (0, So.isUrlProbablySupportMultiRangeRequests)(t)
    }) : r = (0, So.createClient)(t, this, n), this.clientPromise = Promise.resolve(r);
  }
  /**
  ...
  checkIfUpdateSupported(t) {
    const n = t == null ? void 0 : t.minimumSystemVersion, r = (0, a_.release)();
    if (n)
      try {
        if ((0, jt.lt)(r, n))
  ...
  async getUpdateInfoAndProvider() {
    await this.app.whenReady(), this.clientPromise == null && (this.clientPromise = this.configOnDisk.value.then((r) => (0, So.createClient)(r, this, this.createProviderRuntimeOptions())));
  ...
  async loadUpdateConfig() {
    return this._appUpdateConfigPath == null && (this._appUpdateConfigPath = this.app.appUpdateConfigPath), (0, l_.load)(await (0, Ke.readFile)(this._appUpdateConfigPath, "utf-8"));
  }
  ...
  async getOrCreateStagingUserId() {
    ...
    const n = Re.UUID.v5((0, o_.randomBytes)(4096), Re.UUID.OID);
  ...
  async executeDownload(t) {
    ...
    const h = a == null ? null : Je.join(p, `package-${o}${Je.extname(a.path) || ".7z"}`), m = async (T) => {
      ...
      return await (0, Ke.pathExists)(N) && await (0, Ke.copyFile)(N, Je.join(l.cacheDir, "current.blockmap")), h == null ? [f] : [f, h];
  ...
  async differentialDownloadInstaller(t, n, r, i, o) {
    try {
      ...
      const l = async (y) => {
        ...
        try {
          return JSON.parse((0, To.gunzipSync)(E).toString());
        } catch (A) {
      ...
      this.listenerCount(an.DOWNLOAD_PROGRESS) > 0 && (p.onProgress = (y) => this.emit(an.DOWNLOAD_PROGRESS, y));
      const c = async (y, E) => {
        const A = Je.join(E, "current.blockmap");
        await (0, Ke.outputFile)(A, (0, To.gzipSync)(JSON.stringify(y)));
      }, f = async (y) => {
        const E = Je.join(y, "current.blockmap");
        try {
          if (await (0, Ke.pathExists)(E))
            return JSON.parse((0, To.gunzipSync)(await (0, Ke.readFile)(E)).toString());
        } catch (A) {
      ...
      return m == null && (m = await l(s[0])), await new f_.GenericDifferentialDownloader(t.info, this.httpExecutor, p).download(m, h), !1;
    } catch (a) {
...
const Fl = pi, h_ = St;
class p_ extends h_.AppUpdater {
  constructor(t, n) {
...
const sn = Ot, m_ = _r, g_ = ic;
class E_ extends m_.DifferentialDownloader {
  async download() {
...
Ar.FileWithEmbeddedBlockMapDifferentialDownloader = E_;
function hf(e) {
  return JSON.parse((0, g_.inflateRawSync)(e).toString());
}
async function y_(e) {
  ...
  try {
    ...
    return await (0, sn.read)(t, i, 0, i.length, n - r.length - i.length), await (0, sn.close)(t), hf(i);
  } catch (n) {
...
const xl = pe, Ll = pi, w_ = Ot, v_ = It, kn = ae, __ = Qt, A_ = Ar, S_ = fe, Ul = Pt;
class T_ extends __.BaseUpdater {
  ...
  doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      task: async (i, o) => {
        ...
        (t.disableDifferentialDownload || await this.downloadDifferential(r, a, i, n, t)) && await this.httpExecutor.download(r.url, i, o), await (0, w_.chmod)(i, 493);
      }
    });
  }
  async downloadDifferential(t, n, r, i, o) {
    try {
      ...
      return this.listenerCount(Ul.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(Ul.DOWNLOAD_PROGRESS, s)), await new A_.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, a).download(), !1;
    } catch (a) {
...
nr.AppImageUpdater = T_;
var rr = {}, bn = {};
Object.defineProperty(bn, "__esModule", { value: !0 });
bn.LinuxUpdater = void 0;
const C_ = Qt;
class $_ extends C_.BaseUpdater {
  constructor(t, n) {
    super(t, n);
  }
  /**
...
const b_ = fe, kl = Pt, I_ = bn;
class Da extends I_.LinuxUpdater {
  constructor(t, n) {
    super(t, n);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const n = t.updateInfoAndProvider.provider, r = (0, b_.findFile)(n.resolveFiles(t.updateInfoAndProvider.info), "deb", ["AppImage", "rpm", "pacman"]);
    return this.executeDownload({
      fileExtension: "deb",
      fileInfo: r,
      downloadUpdateOptions: t,
  ...
  doInstall(t) {
    ...
    try {
      Da.installWithCommandRunner(i, n, this.runCommandWithSudoIfNeeded.bind(this), this._logger);
    } catch (o) {
...
const Ml = Pt, R_ = fe, O_ = bn;
class Na extends O_.LinuxUpdater {
  constructor(t, n) {
    super(t, n);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const n = t.updateInfoAndProvider.provider, r = (0, R_.findFile)(n.resolveFiles(t.updateInfoAndProvider.info), "pacman", ["AppImage", "deb", "rpm"]);
    return this.executeDownload({
  ...
  doInstall(t) {
    ...
    if (n == null)
      return this.dispatchError(new Error("No update filepath provided, can't quit and install")), !1;
    try {
      Na.installWithCommandRunner(n, this.runCommandWithSudoIfNeeded.bind(this), this._logger);
    } catch (r) {
...
const Bl = Pt, P_ = fe, D_ = bn;
class Fa extends D_.LinuxUpdater {
  constructor(t, n) {
    super(t, n);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const n = t.updateInfoAndProvider.provider, r = (0, P_.findFile)(n.resolveFiles(t.updateInfoAndProvider.info), "rpm", ["AppImage", "deb", "pacman"]);
    return this.executeDownload({
      fileExtension: "rpm",
      fileInfo: r,
      downloadUpdateOptions: t,
...
const jl = pe, Co = Ot, N_ = It, Hl = ae, F_ = Cd, x_ = St, L_ = fe, Gl = pi, ql = fr;
class U_ extends x_.AppUpdater {
  constructor(t, n) {
  ...
  async doDownloadUpdate(t) {
    ...
    const l = (0, L_.findFile)(n, "zip", ["pkg", "dmg"]);
    if (l == null)
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (f, h) => {
        const m = Hl.join(this.downloadedUpdateHelper.cacheDir, c), y = () => (0, Co.pathExistsSync)(m) ? !t.disableDifferentialDownload : (r.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let E = !0;
    ...
    return await new Promise((p, c) => {
      ...
      this.server.on("request", (y, E) => {
        ...
        if (a.info(`${A} requested`), A === "/") {
          ...
          const N = y.headers.authorization.split(" ")[1], k = Buffer.from(N, "base64").toString("ascii"), [q, K] = k.split(":");
...
xa.verifySignature = M_;
const Wl = pe, pf = pi, k_ = mi, Vl = ae;
function mf(e, t) {
...
function M_(e, t, n) {
  return new Promise((r, i) => {
    const o = t.replace(/'/g, "''");
    n.info(`Verifying signature ${o}`), (0, pf.execFile)(...mf(`"Get-AuthenticodeSignature -LiteralPath '${o}' | ConvertTo-Json -Compress"`, 20 * 1e3), (a, s, l) => {
      var p;
      try {
        if (a != null || l) {
          $o(n, a, l, i), r(null);
        ...
        if (c.Status === 0) {
          try {
            const y = Vl.normalize(c.Path), E = Vl.normalize(t);
            if (n.info(`LiteralPath: ${y}. Update Path: ${E}`), y !== E) {
              $o(n, new Error(`LiteralPath of ${y} is different than ${E}`), l, i), r(null);
              return;
            }
          } catch (y) {
...
const Xr = pe, Yl = ae, H_ = Qt, G_ = Ar, zl = Pt, q_ = fe, W_ = Ot, V_ = xa, Xl = Rt;
class Y_ extends H_.BaseUpdater {
  constructor(t, n) {
    super(t, n), this._verifyUpdateCodeSignature = (r, i) => (0, V_.verifySignature)(r, i, this._logger);
  }
  /**
  ...
  /*** @private */
  doDownloadUpdate(t) {
    const n = t.updateInfoAndProvider.provider, r = (0, q_.findFile)(n.resolveFiles(t.updateInfoAndProvider.info), "exe");
    return this.executeDownload({
      fileExtension: "exe",
      downloadUpdateOptions: t,
      fileInfo: r,
  ...
  async differentialDownloadWebPackage(t, n, r, i) {
    ...
    try {
      ...
      this.listenerCount(zl.DOWNLOAD_PROGRESS) > 0 && (o.onProgress = (a) => this.emit(zl.DOWNLOAD_PROGRESS, a)), await new G_.FileWithEmbeddedBlockMapDifferentialDownloader(n, this.httpExecutor, o).download();
    } catch (o) {
...
const Sr = De.dirname(_d(import.meta.url));
process.env.APP_ROOT = De.join(Sr, "..");
let En = null, lr = /* @__PURE__ */ new Map();
const Vo = () => {
  const t = [
    De.join(Sr, "notifications-monitor.ps1"),
    De.join(process.cwd(), "electron", "notifications-monitor.ps1")
  ].find((n) => pn.existsSync(n));
  t && (console.log(`[MAIN] Launching Notification Monitor: ${t}`), En = An("powershell", ["-ExecutionPolicy", "Bypass", "-File", t]), En.stdout.on("data", (n) => {
...
`);
    for (let i of r)
      if (i = i.trim(), i.startsWith("__NOTIF__")) {
        ...
        if (o.length >= 4) {
          const [a, s, l, p] = o;
          lr.set(p, { title: s, app: a }), $e(H, "notification-sync", {
            id: p,
            app: a,
            text: (s + " " + (l || "")).trim()
          });
        ...
        lr.delete(o), $e(H, "notification-remove", o);
      } else i.startsWith("__DEBUG__") && console.log(`[NOTIF_DEBUG] ${i}`);
  }), En.on("exit", () => setTimeout(Vo, 5e3)));
};
X.on("dismiss-notification", (e, t) => {
  ...
  `;
  An("powershell", ["-Command", r]), lr.delete(String(t));
});
X.on("clear-all-notifications", () => {
  An("powershell", ["-Command", `
    $ErrorActionPreference = 'SilentlyContinue'
    [void][Windows.UI.Notifications.Management.UserNotificationListener, Windows.UI.Notifications, ContentType = WindowsRuntime]
    $l = [Windows.UI.Notifications.Management.UserNotificationListener]::Current
    $o = $l.GetNotificationsAsync(1)
...
je.autoUpdater.on("checking-for-update", () => {
  console.log("[UPDATER] Checking for update..."), $e(H, "update-checking");
});
je.autoUpdater.on("update-available", (e) => {
  $e(H, "update-available", {
    version: e.version,
...
je.autoUpdater.on("download-progress", (e) => {
  $e(H, "update-progress", e.percent);
});
je.autoUpdater.on("update-downloaded", () => {
  $e(H, "update-ready");
});
je.autoUpdater.on("update-not-available", () => {
  $e(H, "update-not-available");
});
je.autoUpdater.on("error", (e) => {
  console.error("[UPDATER_ERROR] " + e), $e(H, "update-error", e.message || String(e));
});
X.on("check-for-updates", () => {
  console.log("[UPDATER] Manual check requested"), je.autoUpdater.checkForUpdates().then((e) => {
    ...
    console.error("[UPDATER] Check failed: " + e), $e(H, "update-error", "Error al buscar actualizaciones: " + (e.message || String(e)));
  });
});
X.on("start-update-download", () => {
  console.log("[UPDATER] Starting download..."), je.autoUpdater.downloadUpdate().then(() => {
    ...
    console.error("[UPDATER] Download failed: " + e), $e(H, "update-error", "Error al descargar la actualización.");
  });
});
...
function z_() {
  An("powershell", ["-Command", "[void][Windows.UI.Notifications.Management.UserNotificationListener, Windows.UI.Notifications, ContentType = WindowsRuntime]; [Windows.UI.Notifications.Management.UserNotificationListener]::Current.RequestAccessAsync()"]);
}
const Kl = process.env.VITE_DEV_SERVER_URL, X_ = De.join(process.env.APP_ROOT, "dist");
process.platform === "win32" && Oe.setAppUserModelId("com.notchly.app");
let H, gf = !1, Ef = 0, yf = 440, wf = 66, Yo = !1, zo = !1, ce = "Teams", Mt = !1, ut = !1, Mn = !1, bo = 0, Bn = null, Xo = null, Ko = null, Io = null, We = null, Jo = "";
function $e(e, t, ...n) {
  if (!(!e || e.isDestroyed()))
    try {
...
X.handle("get-system-audio-id", async () => {
  var t;
  return (t = (await ec.getSources({ types: ["screen"] }))[0]) == null ? void 0 : t.id;
});
...
X.on("set-is-expanded", (e, t) => {
  gf = t, t && Date.now() - Jl > 30 * 60 * 1e3 && (Jl = Date.now(), console.log("[UPDATER] Auto-check triggered on expansion"), je.autoUpdater.checkForUpdatesAndNotify().catch(() => {
  }));
});
...
function K_() {
  ...
  H = new vd({
    ...
    webPreferences: {
      preload: De.join(Sr, "preload.js"),
      backgroundThrottling: !1,
      autoplayPolicy: "no-user-gesture-required",
      webviewTag: !0
    }
  }), Kl ? H.loadURL(Kl) : H.loadFile(De.join(X_, "index.html")), H.showInactive(), H.setIgnoreMouseEvents(!1), H.setAlwaysOnTop(!0, "screen-saver"), setTimeout(() => {
    typeof Vo == "function" && Vo(), z_(), _f(), cr(), je.autoUpdater.checkForUpdatesAndNotify().catch((a) => console.error("Update check failed: " + a));
  }, 1e3);
  const o = r + t / 2;
  Bn && clearInterval(Bn), Bn = setInterval(() => {
    try {
      if (!H || H.isDestroyed()) return;
      const { x: a, y: s } = es.getCursorScreenPoint(), l = o + (Ef || 0), p = (yf || 440) / 2, c = wf || 66, f = Math.abs(a - l) < p + 10 && s >= i - 5 && s < i + c + 10;
      let h = !1;
      if (!gf && (Yo || zo)) {
        const y = l - p;
        h = a >= y - (Yo && zo ? 140 : 70) - 20 && a < y - 5 && s >= i - 5 && s < i + 70;
      }
      const m = f || h;
    ...
    Bn && clearInterval(Bn), Xo && clearInterval(Xo), Ko && clearTimeout(Ko), Io && clearInterval(Io), We && clearInterval(We), H = null;
  ...
  }), Qo(), Io = setInterval(Qo, 20 * 60 * 1e3), setInterval(() => {
    console.log("[UPDATER] Periodic 4h check"), je.autoUpdater.checkForUpdatesAndNotify().catch(() => {
    });
  }, 4 * 60 * 60 * 1e3);
}
const J_ = Oe.requestSingleInstanceLock();
J_ ? (Oe.on("second-instance", () => {
...
const Te = (e) => {
  ...
  return new Promise((n) => {
    const r = An("powershell", ["-Command", t]);
    r.stdout.on("data", (i) => {
    }), r.stderr.on("data", (i) => {
    }), r.on("close", () => n(!0));
  });
...
Xo = setInterval(() => {
  try {
    ...
    for (let s = 0; s < r.length; s++) {
      const l = Ql[s].times, p = r[s].times, c = Object.values(l).reduce((h, m) => h + m, 0), f = Object.values(p).reduce((h, m) => h + m, 0);
      i += f - c, o += p.idle - l.idle;
    }
    const a = i > 0 ? (1 - o / i) * 100 : 0;
    Ql = r, $e(H, "system-update", { cpu: a, ram: n, net: 1.5 + Math.random() * 2 });
  } catch {
  }
}, 2e3);
const cr = async () => {
  ...
  if (Oe.isPackaged)
    return De.join(process.resourcesPath, e);
  const t = De.join(process.cwd(), e);
  return pn.existsSync(t) ? t : De.join(Sr, "..", e);
}, Zo = Q_("volume.exe"), vf = () => new Promise((e) => {
...
const Z_ = async (e) => {
  ...
  if (!(!H || H.isDestroyed())) {
    try {
      const e = await vf();
      e >= 0 && $e(H, "volume-update", e);
    } catch {
    }
    Ko = setTimeout(_f, 2e3);
  }
};
let ot = null, ti = null, Zl = /* @__PURE__ */ new Map();
const ea = () => {
  try {
    const e = Oe.isPackaged ? De.join(Sr, "media-reader.js") : De.join(process.cwd(), "electron", "media-reader.mjs");
    console.log(`[MAIN] Launching Media Reader: ${e}`), ot = Ad(e, [process.resourcesPath || ""], {
      ...
      if ((t == null ? void 0 : t.type) === "MEDIA_UPDATE") {
        ...
        n.title && n.title !== "Sin Reproducción" && Zl.set(r, { ...n, timestamp: Date.now() });
        let i = Array.from(Zl.values()).filter((s) => s.title !== "Sin Reproducción").sort((s, l) => l.timestamp - s.timestamp), o = n;
        const a = i.find((s) => s.isPlaying);
        a ? o = a : i.length > 0 && (o = i[0]), ti = o, $e(H, "media-update", o);
      }
    }));
  } catch (e) {
...
try {
  ...
  let e = "", t = null, n = "", r = 0;
  const i = () => {
    const a = De.join(Wt.tmpdir(), "notchly-meet.ps1");
    pn.writeFileSync(a, `
...
'@
    ...
    `, "utf8"), t = An("powershell", ["-ExecutionPolicy", "Bypass", "-File", a]), t.stdout.on("data", (l) => {
      const p = l.toString();
      n += p;
      let c;
      for (; (c = n.indexOf(`
`)) !== -1; ) {
        ...
        if (n = n.slice(c + 1), !f.startsWith("__DEBUG__") && f.startsWith("__MEET__")) {
          ...
          if (h.length >= 6) {
            const [m, y, E, A, C, T, N] = h, k = m.toLowerCase() === "true", q = y.toLowerCase() === "true", K = C.toLowerCase() === "true", Z = (N ?? "").toLowerCase() === "true", te = q && (k || K);
            te ? (bo = 0, E.toLowerCase().includes("zoom") ? ce = "Zoom" : E.toLowerCase().includes("meet") ? ce = "Meet" : E.toLowerCase().includes("teams") ? ce = "Teams" : ce = E || "Llamada") : bo++;
            const L = bo < 6;
...
`;
  X.handle("toggle-wifi", async () => {
    const a = De.join(Wt.tmpdir(), "notchly-radio-cmd.ps1");
  ...
  }), X.handle("get-volume", async () => await vf()), X.handle("set-volume", (a, s) => (Z_(s), !0)), X.handle("open-app", async (a, s) => {
    ...
    ot == null || ot.kill(), typeof t < "u" && t && t.kill(), typeof En < "u" && En && En.kill();
  });
} catch (e) {
